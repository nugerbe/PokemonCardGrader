...
namespace PokemonCardGrader.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260501201140_CenteringLineGuides")]
    partial class CenteringLineGuides
    {
        /// <inheritdoc />
                            ...
                            b1.OwnsOne("PokemonCardGrader.Domain.ValueObjects.AnalysisOverlay", "Overlay", b2 =>
                                {
                                    ...
                                    b2.Property<double>("LeftRightCenteringPercent");

                                    b2.Property<double>("TopBottomCenteringPercent");
                                    ...
                                    b2.OwnsMany("PokemonCardGrader.Domain.ValueObjects.NormalizedPoint", "InnerGuides", b3 =>
                                        {
                                    ...
                                    b2.OwnsMany("PokemonCardGrader.Domain.ValueObjects.NormalizedPoint", "OuterGuides", b3 =>
                                        {
                                            b3.Property<Guid>("AnalysisOverlayImageAnalysisResultImageAnalysisRecordId");
                                    ...
                                    b2.Navigation("InnerGuides");

                                    b2.Navigation("OuterGuides");
                                });
